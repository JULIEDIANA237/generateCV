  ...
  return (
    <div className="p-6 max-w-4xl mx-auto rounded-xl shadow-orange-lg">
      ...
      {experiences.map((experience, index) => (
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6">
            <div>
              <label className="block mb-1 sm:mb-2 font-semibold text-gray-700">Titre du poste</label>
              <input
                type="text"
                value={experience.title}
                onChange={(e) => handleChange(index, 'title', e.target.value)}
                className="w-full border border-gray-300 rounded-lg p-2 sm:p-4 focus:ring-2 focus:ring-orange-400 transition duration-300"
                placeholder="Ex: Développeur Web"
              />
            </div>
            <div>
              <label className="block mb-1 sm:mb-2 font-semibold text-gray-700">Nom de l'organisation</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6">
            <div>
              <label className="block mb-1 sm:mb-2 font-semibold text-gray-700">Date de début (Année)</label>
              <input
                type="number"
            ...
            <div>
              <label className="block mb-1 sm:mb-2 font-semibold text-gray-700">Date de fin (Année)</label>
              <input
                type="number"
          ...
          <div className="mb-6">
            <label className="block mb-1 sm:mb-2 font-semibold text-gray-700">Description du poste</label>
            <textarea
          ...
          >
            ...
            <span className="hidden sm:block text-white">Supprimer une expérience</span>
          </button>
        </div>
      ))}
      ...
      >
        ...
        <span className="hidden sm:block">Ajouter une expérience</span>
      </button>
    </div>
  );
};
